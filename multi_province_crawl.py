...
def inser_data_into_db(data):
    if data:
        try:
            ...
            # pprint(new_data)
            cur.executemany(
                'insert into 一二线城市_copy1 (ori_id,name,unit,xinghao,taxe,pricewithtaxe,note,pricewithoutaxe,province,city,area,year,mon) values (?,?,?,?,?,?,?,?,?,?,?,?,?)',
                (data))
...
if __name__ == "__main__":
    data =crawl_all_pages_data("https://henan.zjtcn.com/gov/c765_cs766_d20181005_t_p1.html", "河南","郑州市","郑州市","2018","5月")
    pprint(data)
 #    data =[['9332578', '砼结构人工', 'm³', '毛石砼', '',  '15.00', '自拌塔吊，最低价', '14.56'],
 # ['9332579', '砼结构人工', 'm³', '毛石砼', '',  '40.00', '自拌塔吊，最高价', '38.83']]
 #    inser_data_into_db(data,'广西','南宁市','南宁市','2018','12')
